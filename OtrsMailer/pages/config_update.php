...
$f_issue_id_tag_template = trim(gpc_get_string( 'issue_id_tag_template' ));
...
$f_issue_menu_show_otrs_search_link = isset($_POST['issue_menu_show_otrs_search_link']);
...
if( $f_reset == true ){
    ...
    # validate input
    if( is_blank( $f_issue_id_tag_template ) ) {
        error_parameters( 'issue_id_tag_template' );
    ...
    config_set_if_changed( 'issue_id_tag_template', $f_issue_id_tag_template );
    ...
    config_set_if_changed( 'issue_menu_show_otrs_search_link', $f_issue_menu_show_otrs_search_link );
}
...
function config_reset()
{
    ...
    plugin_config_delete( 'issue_id_tag_template' );
    ...
    plugin_config_delete( 'issue_menu_show_otrs_search_link' ); 
}
